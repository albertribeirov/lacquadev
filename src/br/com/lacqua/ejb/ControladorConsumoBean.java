...
public class ControladorConsumoBean implements ControladorConsumo {
	...
	@Override
	public void gravarConsumosPorCondominioTorreMes(Leitura pLeitura, List<Leitura> leiturasMesAtual, List<Leitura> leiturasMesAnterior) throws FileNotFoundException {
	...
	@Override
	public void gerarDemonstrativosApartamentos(Leitura pLeitura,
